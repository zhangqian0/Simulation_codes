%function out = model
%
% EMT_display_empty1.m
%
% Model exported on Mar 8 2020, 18:08 by COMSOL 5.4.0.225.

%% 对这个脚本做两项操作 1.将function out=model注释，并将这个脚本结尾的一行注释 2. 添加激励测量循环语句（找到之后赋值粘贴到其他文件一样可用） PS： test1文件同样处理。
...
model.component('comp1').func('im1').set('filename', 'D:\bin\test_genim\100.png');
...
model.component('comp1').view('view1').axis.set('xmin', -99.836181640625);
model.component('comp1').view('view1').axis.set('xmax', 99.836181640625);
