...
% ECT_12x_image9.m
%%%
% Model exported on Jul 15 2019, 18:10 by COMSOL 5.3.0.260.
...
model.component('comp1').geom('geom1').feature('c37').set('pos', [0 0]);
model.component('comp1').geom('geom1').feature('c37').set('r', 15);
model.component('comp1').geom('geom1').create('c38', 'Circle');
model.component('comp1').geom('geom1').feature('c38').active(false);
model.component('comp1').geom('geom1').feature('c38').set('pos', [0 0]);
model.component('comp1').geom('geom1').feature('c38').set('r', 45);
model.component('comp1').geom('geom1').create('b7', 'BezierPolygon');
model.component('comp1').geom('geom1').feature('b7').active(false);
model.component('comp1').geom('geom1').feature('b7').set('p', [-45 45; -25 -25]);
...
model.component('comp1').geom('geom1').feature('b8').set('p', [-50 50; 15 15]);
...
model.component('comp1').physics('es').feature('term1').selection.set([24]);
model.component('comp1').physics('es').create('term2', 'Terminal', 1);
model.component('comp1').physics('es').feature('term2').selection.set([25]);
model.component('comp1').physics('es').create('term3', 'Terminal', 1);
model.component('comp1').physics('es').feature('term3').selection.set([28]);
model.component('comp1').physics('es').create('term4', 'Terminal', 1);
model.component('comp1').physics('es').feature('term4').selection.set([29]);
model.component('comp1').physics('es').create('term5', 'Terminal', 1);
model.component('comp1').physics('es').feature('term5').selection.set([26]);
model.component('comp1').physics('es').create('term6', 'Terminal', 1);
model.component('comp1').physics('es').feature('term6').selection.set([23]);
...
model.component('comp1').physics('es').feature('term8').selection.set([14]);
model.component('comp1').physics('es').create('term9', 'Terminal', 1);
model.component('comp1').physics('es').feature('term9').selection.set([6]);
model.component('comp1').physics('es').create('term10', 'Terminal', 1);
model.component('comp1').physics('es').feature('term10').selection.set([7]);
model.component('comp1').physics('es').create('term11', 'Terminal', 1);
model.component('comp1').physics('es').feature('term11').selection.set([13]);
...
model.component('comp1').physics('es').feature('ccn2').selection.set([1 3]);
